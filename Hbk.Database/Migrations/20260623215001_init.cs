...
namespace Hbk.Database.Migrations
{
    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "fk_clinics_users_manager_user_id",
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_client_practitioners_clients_client_id",
                table: "client_practitioners",
                column: "client_id",
                principalTable: "clients",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_client_practitioners_practitioners_practitioner_id",
                table: "client_practitioners",
                column: "practitioner_id",
                principalTable: "practitioners",
                principalColumn: "id",
            ...
            migrationBuilder.AddForeignKey(
                name: "fk_practices_practitioners_lead_practitioner_id1",
                table: "practices",
                column: "lead_practitioner_id",
                principalTable: "practitioners",
                principalColumn: "id");
