namespace Hbk.Common.Exception;

/// <summary>
/// Hbk.Platform exception base class
...
/// © 2024 NowDoctor Ltd.
/// </summary>
public class HbkException: System.Exception
{
    public HbkException() : base() { }
    public HbkException(string message) : base(message) { }
    public HbkException(string message, System.Exception inner) : base(message, inner) { } 
}
...
public class InvalidUserOperationException : HbkException
{
    ...
    public InvalidUserOperationException(string message, System.Exception inner) : base(message, inner) { } 
};
...
public class MissingFieldException : HbkException
{
    ...
    public MissingFieldException(string message, System.Exception inner) : base(message, inner) { } 
};
...
public class IdxNotFoundException : HbkException
{
    ...
    public IdxNotFoundException(string message, System.Exception inner) : base(message, inner) { } 
}
...
public class InvalidKeyException : HbkException
{
    ...
    public InvalidKeyException(string key, System.Exception inner) : base( $"{key} is not a valid settings key", inner) { } 
}
...
public class DoubleBookingException : HbkException
{
    ...
    public DoubleBookingException(string message, System.Exception inner) : base(message, inner) { } 
}
...
public class TimeslotUnavailableException : HbkException
{
    ...
    public TimeslotUnavailableException(string message, System.Exception inner) : base(message, inner) { } 
}
