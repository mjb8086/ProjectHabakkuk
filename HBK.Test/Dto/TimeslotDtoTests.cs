...
namespace HBK.Test.Dto
{
    ...
    public class TimeslotDtoTests
    {
        ...
        public void VerifyTimeslotDuplicate()
        {
            ...
            Assert.NotEqual(timeslot1.Id, timeslot2.Id);
        ...
        {
            var ts1 = new TimeslotDto() { Time = new TimeOnly(15,00), Duration = 30, Day = Enums.Day.Wednesday };
            var ts2 = new TimeslotDto() { Time = new TimeOnly(15,15), Duration = 30, Day = Enums.Day.Wednesday };
        ...
        {
            var ts1 = new TimeslotDto() { Time = new TimeOnly(15,00), Duration = 30, Day = Enums.Day.Wednesday };
            var ts2 = new TimeslotDto() { Time = new TimeOnly(15,15), Duration = 30, Day = Enums.Day.Tuesday };
        ...
        {
            var ts1 = new TimeslotDto() { Time = new TimeOnly(15,00), Duration = 30, Day = Enums.Day.Wednesday, WeekNum = 10};
            var ts2 = new TimeslotDto() { Time = new TimeOnly(15,15), Duration = 30, Day = Enums.Day.Wednesday, WeekNum = 9};
            Assert.False(ts1.IsClash(ts2));
        }
        ...
        {
            var ts1 = new TimeslotDto() { Time = new TimeOnly(14,00), Duration = 30, Day = Enums.Day.Wednesday };
            var ts2 = new TimeslotDto() { Time = new TimeOnly(14,30), Duration = 30, Day = Enums.Day.Wednesday };
            Assert.False(ts1.IsClash(ts2));
        }
        ...
        {
            var ts1 = new TimeslotDto() { Time = new TimeOnly(14,00), Duration = 30, Day = Enums.Day.Wednesday };
            var ts2 = new TimeslotDto() { Time = new TimeOnly(13,30), Duration = 30, Day = Enums.Day.Wednesday };
            Assert.False(ts1.IsClash(ts2));
        }
        ...
        {
            var ts1 = new TimeslotDto() { Time = new TimeOnly(10,00), Duration = 30, Day = Enums.Day.Wednesday };
            var ts2 = new TimeslotDto() { Time = new TimeOnly(14,30), Duration = 30, Day = Enums.Day.Wednesday };
            Assert.False(ts1.IsClash(ts2));
        }
        ...
        {
            var ts1 = new TimeslotDto() { Time = new TimeOnly(10,00), Duration = 30, Day = Enums.Day.Wednesday };
            var ts2 = new TimeslotDto() { Time = new TimeOnly(18,30), Duration = 30, Day = Enums.Day.Wednesday };
            Assert.False(ts1.IsClash(ts2));
        }
        ...
        {
            var ts1 = new TimeslotDto() { Time = new TimeOnly(11,00), Duration = 120, Day = Enums.Day.Wednesday };
